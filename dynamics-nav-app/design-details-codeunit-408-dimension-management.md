...
---
# <a name="design-details-codeunit-408-dimension-management"></a><span data-ttu-id="4f668-103">Ontwerpdetails: Codeunit 408 Dimensiebeheer</span><span class="sxs-lookup"><span data-stu-id="4f668-103">Design Details: Codeunit 408 Dimension Management</span></span>
<span data-ttu-id="4f668-104">Codeunit 408 Dimensiebeheer is een functiebibliotheek die veel voorkomende taken afhandelt die verband houden met dimensies, zoals kopiëren van de ene tabel naar de andere of van het ene document naar het andere.</span><span class="sxs-lookup"><span data-stu-id="4f668-104">Codeunit 408 Dimension Management is a function library that handles common tasks that are related to dimensions, such as copying from one table to another or from one document to another.</span></span> <span data-ttu-id="4f668-105">In dit onderwerp worden de functies genoemd die in Microsoft Dynamics NAV 2013 R2 zijn gewijzigd en er wordt aangegeven wat er met de functies moet gebeuren.</span><span class="sxs-lookup"><span data-stu-id="4f668-105">This topic lists the functions that are modified in Microsoft Dynamics NAV 2013 R2 and specifies what has to be done to the functions.</span></span> <span data-ttu-id="4f668-106">Veel functies zijn verwijderd omdat er geen reden is om te kopiëren tussen dimensietabellen.</span><span class="sxs-lookup"><span data-stu-id="4f668-106">Many functions are deleted because there is no need for copying between dimension tables.</span></span>  

## <a name="modified-functions"></a><span data-ttu-id="4f668-107">Gewijzigde functies</span><span class="sxs-lookup"><span data-stu-id="4f668-107">Modified Functions</span></span>  

|<span data-ttu-id="4f668-108">Functienaam</span><span class="sxs-lookup"><span data-stu-id="4f668-108">Function Name</span></span>|<span data-ttu-id="4f668-109">Beschrijving wijziging</span><span class="sxs-lookup"><span data-stu-id="4f668-109">Modification Description</span></span>|  
|-------------------|------------------------------|  
|<span data-ttu-id="4f668-110">CheckDimSetIDComb</span><span class="sxs-lookup"><span data-stu-id="4f668-110">CheckDimSetIDComb</span></span>|<span data-ttu-id="4f668-111">Nieuwe functie die de overige controlefuncties vervangt en die een dimensieset-id als argument gebruikt in plaats van een dimensietabel.</span><span class="sxs-lookup"><span data-stu-id="4f668-111">New function that substitutes the other check functions and takes a Dimension Set ID as an argument instead of a dimension table.</span></span>|  
|<span data-ttu-id="4f668-112">CheckDimSetIDComb</span><span class="sxs-lookup"><span data-stu-id="4f668-112">CheckDimSetIDComb</span></span><br /><br /> <span data-ttu-id="4f668-113">CheckDocDimComb</span><span class="sxs-lookup"><span data-stu-id="4f668-113">CheckDocDimComb</span></span><br /><br /> <span data-ttu-id="4f668-114">CheckServContractDimComb</span><span class="sxs-lookup"><span data-stu-id="4f668-114">CheckServContractDimComb</span></span><br /><br /> <span data-ttu-id="4f668-115">CheckDimBuffer</span><span class="sxs-lookup"><span data-stu-id="4f668-115">CheckDimBuffer</span></span><br /><br /> <span data-ttu-id="4f668-116">CheckDimComb</span><span class="sxs-lookup"><span data-stu-id="4f668-116">CheckDimComb</span></span><br /><br /> <span data-ttu-id="4f668-117">CheckDimValueComb</span><span class="sxs-lookup"><span data-stu-id="4f668-117">CheckDimValueComb</span></span>|<span data-ttu-id="4f668-118">Wissen.</span><span class="sxs-lookup"><span data-stu-id="4f668-118">Delete.</span></span> <span data-ttu-id="4f668-119">Al het gebruik moet worden gewijzigd in CheckDimSetIDComb.</span><span class="sxs-lookup"><span data-stu-id="4f668-119">All usage should be changed to CheckDimSetIDComb.</span></span>|  
|<span data-ttu-id="4f668-120">GetDefaultDim</span><span class="sxs-lookup"><span data-stu-id="4f668-120">GetDefaultDim</span></span>|<span data-ttu-id="4f668-121">Wijzigen om een geheel-getal dimensieset-id te retourneren in plaats van een set records.</span><span class="sxs-lookup"><span data-stu-id="4f668-121">Modify to return an integer Dimension Set ID instead of a set of records.</span></span>|  
|<span data-ttu-id="4f668-122">CopyJnlLineDimToICJnlDim</span><span class="sxs-lookup"><span data-stu-id="4f668-122">CopyJnlLineDimToICJnlDim</span></span><br /><br /> <span data-ttu-id="4f668-123">CopyICJnlDimToJnlLineDim</span><span class="sxs-lookup"><span data-stu-id="4f668-123">CopyICJnlDimToJnlLineDim</span></span><br /><br /> <span data-ttu-id="4f668-124">CopyDocDimtoICDocDim</span><span class="sxs-lookup"><span data-stu-id="4f668-124">CopyDocDimtoICDocDim</span></span><br /><br /> <span data-ttu-id="4f668-125">CopyICDocDimtoICDocDim</span><span class="sxs-lookup"><span data-stu-id="4f668-125">CopyICDocDimtoICDocDim</span></span>|<span data-ttu-id="4f668-126">Wijzigen voor gebruik met DimSetID > ICJnlLineDim</span><span class="sxs-lookup"><span data-stu-id="4f668-126">Modify to work with DimSetID -> ICJnlLineDim</span></span>|  

## <a name="deleted-functions"></a><span data-ttu-id="4f668-127">Verwijderde functies</span><span class="sxs-lookup"><span data-stu-id="4f668-127">Deleted Functions</span></span>  
...
>  <span data-ttu-id="4f668-129">Tijdens de upgrade van de vereffeningcode van Microsoft Dynamics NAV 2009 of eerdere versies naar Microsoft Dynamics NAV 2016 zijn de volgende functies niet beschikbaar in Microsoft Dynamics NAV 2016.</span><span class="sxs-lookup"><span data-stu-id="4f668-129">During the upgrade of application code from Microsoft Dynamics NAV 2009 or earlier versions to Microsoft Dynamics NAV 2016, the following functions are not available in Microsoft Dynamics NAV 2016.</span></span> <span data-ttu-id="4f668-130">Als u aanpassingen hebt die een of meer van de functies gebruiken, moet u die code upgraden.</span><span class="sxs-lookup"><span data-stu-id="4f668-130">If you have customizations that use one or more of the functions, you must upgrade that code accordingly.</span></span>
 ...
 <span data-ttu-id="4f668-144">GetDocDim</span><span class="sxs-lookup"><span data-stu-id="4f668-144">GetDocDim</span></span>  
 ...
 <span data-ttu-id="4f668-164">ShowTempDim</span><span class="sxs-lookup"><span data-stu-id="4f668-164">ShowTempDim</span></span>  
 ...
 <span data-ttu-id="4f668-184">CopySCDimToDocDim</span><span class="sxs-lookup"><span data-stu-id="4f668-184">CopySCDimToDocDim</span></span>  
 ...
 <span data-ttu-id="4f668-205">CopyJnlLineDimToBuffer</span><span class="sxs-lookup"><span data-stu-id="4f668-205">CopyJnlLineDimToBuffer</span></span>  
